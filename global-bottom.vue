...
const size = computed(() => 520 *  scaleFactor.value)
const blur = computed(() => 140 * scaleFactor.value)
const followMouse = computed(() => pressed.value)
const left = computed(() => (followMouse.value ? mouseX.value : '80'))
const top = computed(() => (followMouse.value ? mouseY.value : '30'))
